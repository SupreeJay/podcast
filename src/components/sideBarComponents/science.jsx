...
import { useFavorites } from '../../context/favoriteContext'; // 1. Import the global hook
...
const ScienceDisplay = () => {
    // 2. Consume global favorites state and toggle function from Context
    ...
    useEffect(() => {
        const getPodcasts = async () => {
            const itunesUrl = 'https://itunes.apple.com/search?term=science&entity=podcastEpisode&limit=100genreId=1315';
            try {
                ...
                if (data.results) {
                    const formattedData = data.results.map((item) => {
                        ...
                        return {
                            ...
                            tag: item.primaryGenreName || "Science",
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", color: "white" }}>
                ...
                <tbody>
                    {podcasts.map((podcast, index) => {
                        // 4. Reactive check: Is this specific podcast in global favorites?
