...
const HistoryDisplay = () => {
    ...
    const handleFavoriteClick = (podcast) => {
        ...
        // Only show "Added" popup if we are adding to favorites
        if (!isCurrentlyFav) {
    ...
    useEffect(() => {
        const getPodcasts = async () => {
            const itunesUrl = 'https://itunes.apple.com/search?term=history&entity=podcastEpisode&limit=100genreId=1487';
            try {
                ...
                if (data.results) {
                    const formattedData = data.results.map((item) => {
                        ...
                        return {
                            ...
                            tag: item.primaryGenreName || "History",
