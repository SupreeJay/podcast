...
import { useFavorites } from '../../context/favoriteContext'; // 1. Import the global context hook
...
const LeadershipDisplay = () => {
    // 2. Consume favorites and toggle function from Context
    ...
    useEffect(() => {
        const getPodcasts = async () => {
            const itunesUrl = 'https://itunes.apple.com/search?term=leadership&entity=podcastEpisode&limit=100genreId=1491';
            try {
                ...
                if (data.results) {
                    const formattedData = data.results.map((item) => {
                        ...
                        return {
                            ...
                            tag: item.primaryGenreName || "Leadership",
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", color: "white" }}>
                ...
                <tbody>
                    {podcasts.map((podcast, index) => {
                        // 4. Check if this podcast exists in global favorites list
