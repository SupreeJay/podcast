...
const NewsDisplay = () => {
    // 2. Consume favorites state and toggle function from Context
    ...
    // 3. Updated Favorite Handler: Uses global context logic
    ...
    useEffect(() => {
        const getPodcasts = async () => {
            const itunesUrl = 'https://itunes.apple.com/search?term=news&entity=podcastEpisode&limit=100genreId=1489';
            try {
                ...
                if (data.results) {
                    const formattedData = data.results.map((item) => {
                        ...
                        return {
                            ...
                            tag: item.primaryGenreName || "News",
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", color: "white" }}>
                ...
                <tbody>
                    {podcasts.map((podcast, index) => {
                        // 4. Check if this specific podcast is in global favorites
