...
const EntrepreneurshipDisplay = () => {
    ...
    const handleFavoriteClick = (podcast) => {
        ...
        // Show "Added" popup only when adding
        if (!isCurrentlyFav) {
    ...
    useEffect(() => {
        const getPodcasts = async () => {
            const itunesUrl = 'https://itunes.apple.com/search?term=entrepreneurship&entity=podcastEpisode&limit=100&genreId=1493';
            try {
                ...
                if (data.results) {
                    const formattedData = data.results.map((item) => {
                        ...
                        return {
                            ...
                            tag: item.primaryGenreName || "Entrepreneur",
...
export default EntrepreneurshipDisplay;
